...
import { Button, Text, Container, Section, Link, Hr } from '@react-email/components';
...
export default function VerifyEmail({ url = 'https://example.com/verify-email' }: VerifyEmailProps) {
    return (
        <Layout
            ...
            <Container className="mx-auto max-w-[480px] bg-white rounded-2xl shadow p-8">
                <Section className="text-center">
                    ...
                    <Text className="text-gray-600 text-sm mt-6">
                        If the button doesn’t work, you can also verify your email by copying and pasting the link below into your browser:
                    </Text>
