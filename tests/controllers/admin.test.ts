...
describe("Admin Controller", () => {
  ...
  describe("login", () => {
    ...
    it("should return same token format as signup", async () => {
      ...
      const signupResult = await adminController.createadmin(
        signupInput,
        adminModelMock as any,
      );
      const loginResult = await adminController.login(
        loginInput,
        adminModelMock as any,
      );
  ...
  describe("Business Management", () => {
    ...
    describe("getBusinessesByStatus", () => {
      ...
      it("should handle edge case pagination values", async () => {
        ...
        await adminController.getBusinessesByStatus(
          undefined,
          1,
          1,
          adminModelMock as any,
    ...
    describe("approveBusiness", () => {
      it("should approve business successfully", async () => {
        (adminModelMock.approveBusiness as jest.Mock).mockResolvedValue(
          undefined,
        );
        ...
        expect(adminModelMock.approveBusiness).toHaveBeenCalledWith(
          mockBusinessId,
          mockAdminId,
        );
    ...
    describe("suspendBusiness", () => {
      it("should suspend business successfully", async () => {
        (adminModelMock.suspendBusiness as jest.Mock).mockResolvedValue(
          undefined,
        );
        ...
        expect(adminModelMock.suspendBusiness).toHaveBeenCalledWith(
          mockBusinessId,
          mockAdminId,
        );
    ...
    describe("business management integration scenarios", () => {
      ...
      it("should handle business management with different admin users", async () => {
        ...
        await adminController.approveBusiness(
          mockBusinessId,
          admin1Id,
          adminModelMock as any,
        );
        await adminController.suspendBusiness(
          mockBusinessId,
          admin2Id,
          adminModelMock as any,
        );
