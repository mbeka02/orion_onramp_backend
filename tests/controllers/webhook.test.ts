...
describe("Webhook Controller: Send Event tests", () => {
  ...
  beforeAll(async () => {
    transactionModelMock.getWebhookControllerTransactionDetails = jest
      .fn()
      .mockImplementation((transaction_reference: string) => {
        return new Promise((res, rej) => {
          if (transaction_reference === nonExistentTransactionRef) {
            ...
            transaction_reference === paymentRequestPendingTransactionRef
          ) {
            res({
              transaction_reference,
              environmentID,
            ...
            transaction_reference === paymentRequestSuccessTransactionRef
          ) {
            res({
              transaction_reference,
              environmentID,
    ...
    webhookModelMock.generateSignature = jest
      .fn()
      .mockImplementation((data, webhookSecret) => {
    ...
    environmentModelMock.getEnvironmentWebhookDetails = jest
      .fn()
      .mockImplementation((environment_id, encryption_service) => {
        return new Promise((res, rej) => {
